...
test_inputs = [
    (2 * (3**2) * (5**3), 0, eq),  # = 2250, Even `len(T)`, and `len(T) == next_fast_len(len(T))`
    ((3**2) * (5**3), 1, eq),  # = 1125, Odd `len(T)`, and `len(T) == next_fast_len(len(T))`. 
    (2 * 7 * 11 * 13, 0, lt),  # = 2002, Even `len(T)`, and `len(T) < next_fast_len(len(T))`
